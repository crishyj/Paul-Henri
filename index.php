                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="email" class="lang" key="email"> </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="country" class="lang" key="country"></label><span style="color: red !important; display: inline; float: none;">*</span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="code" class="lang" key="code"> </label>
